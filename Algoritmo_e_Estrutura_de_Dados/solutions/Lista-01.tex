...
\begin{exercise}{K-Maior}{}
    Deixamos como exercício para o leitor a criação de um algoritmo que identifica o k-ésimo maior elemento de uma lista com $n$ elementos.
\end{exercise}
...
\begin{exercise}{Custo $O(n)$}{}
    ...
    Mas você pode impor limitações, por exemplo, $\forall 1 \leq i \leq n$, $1 \leq L[i] \leq n$, em suas construções para análises simplificadas.
\end{exercise}
